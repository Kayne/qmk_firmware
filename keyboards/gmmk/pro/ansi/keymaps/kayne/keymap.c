...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    [LINUX] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,              KC_RALT, KC_RCTL, TT_FN,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [MACOS] = LAYOUT(
        ...
        _______, KC_LALT, KC_LGUI,                            LT(FUNCTIONS, KC_SPC),                            KC_RGUI, KC_RALT, _______, _______, _______, _______
    ),
    ...
    [FUNCTIONS] = LAYOUT(
        ...
        _______, _______, _______,                            RGB_TOG,                            _______, _______, _______, RGB_HUD, RGB_RMOD, RGB_HUI
    ),
    // Not used at present
    [GIT] = LAYOUT(
